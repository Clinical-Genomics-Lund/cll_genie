...
class ProcessExcel:
    ...
    def __init__(self, file, excel_header_row, excel_sheet_name, filtration_cutoff, no_stop_codon, is_in_frame):
    ...
    def read(self):
        ...
        data = None
        try:
            data = pd.read_excel(self.file_path, sheet_name=self.excel_sheet_name, header=self.excel_header_row, engine='openpyxl')
    ...
    def filter_data(self):
        ...
        try:
            ...
            # Filter the data based on the given conditions
                ...
                filtered_data = df[(df['% total reads'] >= self.filtration_cutoff)
    ...
    def extract_sequences(self, dataframe):
        ...
        ranks_sequences = list(dataframe[['Rank', 'Sequence'
